...
from .views.storefront.auth import (
    register_user,
    login_page,
    logout_user
)

from .views.storefront.home import home, contact

from .views.storefront.product import (
    product_list,
    product_detail
)

from .views.storefront.cart import (
    cart,
    add_to_cart,
    update_quantity,
    increase_quantity,
...
from .views.storefront.checkout import (
    checkout,
    vnpay_return,
    vnpay_ipn
)

from .views.storefront.order import (
    my_orders,
    order_detail
)

from .views.storefront.profile import (
    profile,
    profile_update,
    change_password
)

from .views.storefront.wishlist import (
    wishlist,
    add_wishlist,
    remove_wishlist
)

from .views.admin_panel.dashboard import dashboard

from .views.admin_panel.product import (
    admin_products,
    add_product,
    edit_product,
    delete_product
...
from .views.admin_panel.category import (
    admin_category,
    add_category,
    edit_category,
    delete_category
...
from .views.admin_panel.order import (
    admin_order,
    admin_order_detail,
    update_order_status
)

from .views.admin_panel.customer import (
    admin_customer,
    customer_detail,
    edit_customer,
